...
class ExperienceManager:
    ...
    def extract_projectiles_2d_coordinates(self, extraction_postprocessing_function: callable = noop):
        ...
        self.projectiles_coordinates_2d = extraction_postprocessing_function(self.projectiles_coordinates_2d)
